...
class Recommendation_Integration implements Integration {
	...
	public function inject_base_snippet(): void {
		...
		wp_enqueue_script( 'gr-reco-snippet', $recommendation_snippet, array(), 1, true );
	...
	private function add_recommendation_payload_script( array $recommendation_payload ): void {
		wp_register_script( 'gr-reco-payload', false, array(), array(), true );
	...
	private function get_category( $category, $categories = array() ): string {
