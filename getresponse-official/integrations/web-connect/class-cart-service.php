...
use GetResponse\WordPress\Integrations\WebConnect\Model\Buffer\Cart_Model as Buffer_Cart_Model;
...
class Cart_Service {
	...
	private function add_event_to_buffer( string $cart_id, WC_Cart $cart ): void {
